...
/**
 * The diary feed: completed quests, newest first — plus the party-completion
 * claim loop (pull party mates' completions, claim XP + diary entries).
 * Renders on /profile (and legacy /journal). The claim effect must live
 * wherever the diary renders, so it stays inside this component.
 */
export default function DiaryList() {
  const { activeQuests, onlineParty, myUserId, claimCompletion } = useStore()
